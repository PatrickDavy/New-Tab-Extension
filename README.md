...
For bug reporting, feature requests and general questions click [here](https://github.com/PatrickDavy/New-Tab-Extension/issues) and be sure to properly label 

Developed by : [Patrick Davy](https://www.linkedin.com/in/patrick-davy/)
